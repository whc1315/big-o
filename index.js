...
// ANSWER: No, O(1) is the best there is.
...
// ANSWER: No its not...
// function getNumbersSquared(numbers) {
//   let numbers2 = numbers.map(i => i * i);
...
// Q: Do these functions have the same space complexity? Yes
// ANSWER:
...
// ANSWER: I counted the steps and got rid of the less important parts to coe up with O(n) for both.
